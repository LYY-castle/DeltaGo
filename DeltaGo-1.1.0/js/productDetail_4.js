$(function(){
	...
	$('.area7').on('click','.inReport',function(){
		window.location.href = '../template/touzibaogaozhinenglun.html?productId='+pid+'&year='+$(this).attr('data-year')+'&shengyu='+shengyu+'&time='+nowDate+'&marketStatus='+marketStatus;
	})
